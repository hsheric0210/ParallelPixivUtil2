namespace ParallelPixivUtil2
{
	...
	public class SecureLookupSection
	{
		...
		public string ArchiveCommand { get; set; } = "Add -Name={UserID} -Path=\"{Source}\" -Repository=\"{ArchiveFolder}\" -Tags=\"Username={UserName};UserID={UserID}\" -Urls=\"{UserUrl}\" -ReusePreviousName -Append=\"{BatchFile}\"";
